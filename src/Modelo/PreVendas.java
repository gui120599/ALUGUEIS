 ...
 */
public class PreVendas {

    private int cod_pre_venda;
    ...
    public PreVendas(int cod_pre_venda, int cod_cliente, String descricao_venda, double valor_custo, double valor_venda, double valor_lucro, double valor_desconto, String data_venda, int cod_condicao_pagamento, int cod_tipo_pagamento) {
        this.cod_pre_venda = cod_pre_venda;
    ...
    public int getCod_pre_venda() {
        return cod_pre_venda;
    }

    public void setCod_pre_venda(int cod_pre_venda) {
        this.cod_pre_venda = cod_pre_venda;
    }
