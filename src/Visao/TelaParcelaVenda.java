 ...
 */
public class TelaParcelaVenda extends javax.swing.JFrame {

    /**
     * Creates new form TelaCliente
     */
    public TelaParcelaVenda() {
        initComponents();
        MostrarCliente();
    ...
    public void MostrarCliente() {
        JTParcelaVenda.getColumnModel().getColumn(0).setPreferredWidth(60);
        JTParcelaVenda.getColumnModel().getColumn(1).setPreferredWidth(100);
        JTParcelaVenda.getColumnModel().getColumn(2).setPreferredWidth(70);
        DefaultTableModel modelo = (DefaultTableModel) JTParcelaVenda.getModel();
        modelo.setNumRows(0);
        ParcelaVendaDao cdao = new ParcelaVendaDao();

        cdao.BuscarParcelaVenda().forEach((c) -> {
    ...
    public void Salvar() {
        ...
        if (TxtNome.getText() == null || TxtNome.getText().equals("")) {
            ...
            c.setTelefone_cliente(TxtDataVencimento.getText());
    ...
    private void initComponents() {
        ...
        JTParcelaVenda = new javax.swing.JTable();
        ...
        jLabel1.setText("Parcelas de vendas");
        ...
        JTParcelaVenda.setFont(new java.awt.Font("Calibri", 2, 14)); // NOI18N
        JTParcelaVenda.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código Venda", "Valor", "Vencimento"
            }
        ));
        JTParcelaVenda.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                JTParcelaVendaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(JTParcelaVenda);
        ...
        ButtonTelefone.setText("Data de Vencimento");

        TxtDataVencimento.setFont(new java.awt.Font("Calibri", 2, 14)); // NOI18N
    ...
    private void JTParcelaVendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTParcelaVendaMouseClicked
        if (JTParcelaVenda.getSelectedRow() != -1) {
            TxtCod.setText(JTParcelaVenda.getValueAt(JTParcelaVenda.getSelectedRow(), 0).toString());
            TxtNome.setText(JTParcelaVenda.getValueAt(JTParcelaVenda.getSelectedRow(), 1).toString());
            TxtDataVencimento.setText(JTParcelaVenda.getValueAt(JTParcelaVenda.getSelectedRow(), 2).toString());
        }
    }//GEN-LAST:event_JTParcelaVendaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaParcelaVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaParcelaVenda().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable JTParcelaVenda;
